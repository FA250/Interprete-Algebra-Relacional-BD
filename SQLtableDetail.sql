...
--ver tablas
--select COLUMN_NAME,DATA_TYPE,CHARACTER_MAXIMUM_LENGTH,NUMERIC_PRECISION,NUMERIC_SCALE,Primaria,Foranea,CHECK_CLAUSE from diccionario where TABLE_NAME='<tabla1>'
--ver referencia crusada
--select COLUMN_NAME,DATA_TYPE,CHARACTER_MAXIMUM_LENGTH,NUMERIC_PRECISION,NUMERIC_SCALE,Primaria,Foranea,CHECK_CLAUSE from diccionario where COLUMN_NAME='<atrib>'
--select TABLE_NAME from diccionario where COLUMN_NAME='<atrib>'